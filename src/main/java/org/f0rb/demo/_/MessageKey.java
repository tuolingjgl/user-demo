...
public interface MessageKey {
    ...
    public final String INCORRECT_PASSWORD = "user.password.incorrect";
    public final String USERNAME_INVALID = "user.username.invalid";
    public final String PASSWORD_INVALID = "user.password.invalid";
    public final String PASSWORD_MISMATCH = "user.password.mismatch";
